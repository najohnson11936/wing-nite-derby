...
export const HORSES: Horse[] = [
  { post: 1,  name: "Renegade",        jockey: "Irad Ortiz Jr.",        trainer: "Todd Pletcher",    odds: "9/2",  oddsNum: 4.5 },
  { post: 2,  name: "Albus",           jockey: "Manuel Franco",         trainer: "Riley Mott",       odds: "50-1", oddsNum: 50  },
  { post: 3,  name: "Intrepido",       jockey: "Hector Berrios",        trainer: "Jeff Mullins",     odds: "57-1", oddsNum: 57  },
  ...
  { post: 14, name: "Potente",         jockey: "Juan Hernandez",        trainer: "Bob Baffert",      odds: "24-1", oddsNum: 24  },
  { post: 15, name: "Emerging Market", jockey: "Flavien Prat",          trainer: "Chad Brown",       odds: "11-1", oddsNum: 11  },
  { post: 16, name: "Pavlovian",       jockey: "Edwin Maldonado",       trainer: "Doug O'Neill",     odds: "50-1", oddsNum: 50  },
  { post: 17, name: "Six Speed",       jockey: "Brian Hernandez Jr.",   trainer: "Bhupat Seemar",    odds: "40-1", oddsNum: 40  },
  { post: 18, name: "Further Ado",     jockey: "John Velazquez",        trainer: "Brad Cox",         odds: "7-1",  oddsNum: 7   },
  { post: 19, name: "Golden Tempo",    jockey: "Jose Ortiz",            trainer: "Cherie Devaux",    odds: "40-1", oddsNum: 40  },
  { post: 21, name: "Great White",     jockey: "Alex Achard",           trainer: "John Ennis",       odds: "33-1", oddsNum: 33  },
...
export const ODDS_LAST_UPDATED = "Apr 30, 2026 — 4:00 PM ET";
